...
def lambda_handler(event, context):
    ...
    if event["RequestType"] == 'Delete':
        ...
        try:
            ...
            print("printing all the kda app properties:", properties)
            ...
            plugin_name = f'{stack_name}-s3plugin'
            ...
            print("Plugin properties:",connect_response_create_pl)
            ...
            connectorDescription='s3-sink',
            connectorName=f'{stack_name}-s3-sink',
            kafkaCluster={
                'apacheKafkaCluster': {
            ...
            print("s3 Connector properties sent:",connect_responsecreate_con)
